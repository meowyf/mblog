...
<div class="wrapper">
    ...
    <header class="main-header">
        <a href="${base}/index" class="logo">
            ...
            <span class="logo-lg"><b>M</b>EOW</span>
        </a>
    ...
    <footer class="main-footer">
        <!-- To the right -->
        <div class="pull-right hidden-xs">V${site.version}</div>
        <!-- Default to the left -->
        <strong>Copyright &copy; 2020 <a href="https://github.com/meowyf">meowyf</a>.</strong> All rights reserved.
    </footer>
</body>
</html>
</#macro>
